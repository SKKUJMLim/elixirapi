defmodule HelloApiWeb.UserControllerTest do
  use HelloApiWeb.ConnCase

  alias HelloApi.Scheme

  @create_attrs %{name: "some name", password: "some password", phonenum: "some phonenum", user_id: "some user_id"}
  ...
  def fixture(:user) do
    {:ok, user} = Scheme.create_user(@create_attrs)
    user
  end
